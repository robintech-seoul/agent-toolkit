---
name: reject
description: Revise the pending MVP-Builder artifact using the user’s rejection feedback.
---
...
Command shape: `python3 <resolved-plugin>/bin/pipeline.py --project <project> reject`.

Save the user's feedback verbatim to a temporary UTF-8 file and pass `--reason-file <file>`. Remove it afterward. Rejection revises the same stage; it does not authorize approval.
